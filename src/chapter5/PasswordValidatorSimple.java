...
public class PasswordValidatorSimple {
    ...
    /* preia valoarea locala a username si currentPassword si le atribuie una globala*/
    public PasswordValidatorSimple (String username, String currentPassword){ /*constructor, initializam var*/
        this.username = username;
        this.currentPassword = currentPassword;
    }

    public boolean isValid(){ /*metoda*/
        return valid;
    }

    public String getErrorMessage(){ /*metoda*/
        return errorMessage;
    }
    ...
    public static PasswordValidatorSimple login(){ /*constructor, initializam introducerea numelor*/
        ...
        return new PasswordValidatorSimple(username, password);
    }
    ...
    public String getProposedPassword(){  /*metoda care returneaza noua parola introdusa*/
        System.out.println("Enter your new password:");
        return scanner.nextLine();
    }

    public void changePassword(String newPassword){ /*metoda care ne zice daca sa sch parola*/
